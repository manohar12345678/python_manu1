   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: pymysql in c:\\users\\rosey\\anaconda3\\lib\\site-packages (1.0.2)\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "\n",
       "    Other_Sales  Global_Sales   Released  \n",
       "0          8.46         82.74  post 2005  \n",
       "1          0.77         40.24   pre 2005  \n",
       "2          3.31         35.82  post 2005  \n",
       "3          2.96         33.00  post 2005  \n",
       "4          1.00         31.37   pre 2005  \n",
       "5          0.58         30.26   pre 2005  \n",
       "6          2.90         30.01  post 2005  \n",
       "7          2.85         29.02  post 2005  \n",
       "8          2.26         28.62  post 2005  \n",
       "9          0.47         28.31   pre 2005  \n",
       "10         2.75         24.76       None  \n",
       "11         1.92         23.42       None  \n",
       "12         0.71         23.10   pre 2005  \n",
       "13         2.15         22.72  post 2005  \n",
       "14         1.79         22.00  post 2005  \n",
       "15         1.67         21.82  post 2005  \n",
       "16         4.14         21.40  post 2005  \n",
       "17        10.57         20.81   pre 2005  \n",
       "18         0.55         20.61   pre 2005  \n",
       "19         2.05         20.22       None  "
      ]
     },
     "execution_count": 8,
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "   Global_Sales   Released\n",
       "0      0.489448  post 2005\n",
       "1      0.649884   pre 2005\n",
       "2      0.488778       None"
      ]
     },
